...
<head>
    <script type="text/javascript">
        function eliminiar(imagen){
            if (confirm("Vas a eleminar la imagen" + imagen)) {
                window.location ="index.php?imagen="+imagen 
            }
        }
    </script>
    <meta charset="UTF-8">
        ...
        <div class="row tm-mb-90 tm-gallery">
        	...
        	<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="<?=$file . $imagen?>" alt="Image" class="img-fluid">
                ...
                <div class="d-flex justify-content-between tm-text-gray">
                    <span class="tm-text-gray-light"><a href="<?=$file . $imagen?>" download>Descargar</a></span>
                    <span><a href="" onclick="eliminar('<?php echo $imagen;?>')">Eleminar</a></br></span>
                </div>
            </div>
            <?php
            }
