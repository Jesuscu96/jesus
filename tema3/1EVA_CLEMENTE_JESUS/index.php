...
<body>
    ...
    <?php
    //si se ha pulsado en una categoria
    if(isset($_GET['cat'])){
        $libros = $libroObj->getByCategoria($_GET['cat']);
        echo "<h3>Libros de la categoría seleccionada</h3><div class='row'>";

    //archivo inicial del index sin pulsar en categoria
    }else{
        $librosPop = $libroObj->getPopulares();
        $libroNew = $libroObj->getRecientes();
